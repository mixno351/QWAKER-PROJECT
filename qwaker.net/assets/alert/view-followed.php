...
<div class="qak-alert-container" id="qak-alert-container">
	<div class="qak-alert-container-holder">
		<h2 class="qak-alert-container-holder-title" id="alert-title-qak">
			<?php echo $string['title_followed']; ?>
	...
	<script type="text/javascript">
		loadListFollowed();
		function loadListFollowed() {
			$.ajax({type: "POST", url: "/assets/content/list-content-followed.php", data: {id: '<?php echo $id; ?>'}, success: function(result) {
