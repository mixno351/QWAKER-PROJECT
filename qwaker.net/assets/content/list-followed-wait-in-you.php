			...
			<div class="qak-popup-alert-item" id="qak-popup-alert-item-<?php echo $value['user_id']; ?>">
				...
				<div class="qak-popup-alert-item-content">
					<h2 class="qak-popup-alert-item-title">
						<?php echo $string['title_request_new_follower']; ?>
					...
					<h2 class="qak-popup-alert-item-message"><?php echo str_replace('%1s', '@'.$value['user_login'], $string['message_user_follow_in_you']); ?></h2>
					<div class="qak-popup-alert-item-actions">
						...
						<button onclick="goRejectFollow(<?php echo $value['user_id']; ?>)" class="border"><?php echo $string['action_request_reject']; ?></button>
					</div>
				</div>
			</div>
		<?php } ?>
	<?php } else { ?>
		<h2 class="message_popup"><?php echo $string['message_no_followed_wait_inyou']; ?></h2>
	<?php } ?>
</div>